...
public class MapFragment extends Fragment implements OnMapReadyCallback,GoogleMap.OnMarkerClickListener{
    ...
    private int[] myImageList = new int[]{R.drawable.su,R.drawable.newmyeong, R.drawable.myeong,
            R.drawable.law,R.drawable.sun,R.drawable.student,R.drawable.hang,R.drawable.su,R.drawable.noon,R.drawable.injae,
            R.drawable.science,R.drawable.su,R.drawable.sociology,R.drawable.art,
